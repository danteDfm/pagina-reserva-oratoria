...
export  const Nav = () => {
    return(<>
        ...
        <header className="nav">
            ...
            <div className='content_iconos'>
            <ul>
                <li><div className='icon_insta icon_redes'></div></li>
                <li><div className='icon_likedin icon_redes'></div></li>
                <li><div className='icon_whattsapp icon_redes'></div></li>
                <li><div className='icon_facebook icon_redes'></div></li>
            </ul>
            </div>
        </header>
